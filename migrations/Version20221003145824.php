 ...
 */
final class Version20221003145824 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE invoice_lines (id INT AUTO_INCREMENT NOT NULL, invoice_id_id INT NOT NULL, description LONGTEXT NOT NULL, quantity INT NOT NULL, amount NUMERIC(10, 2) NOT NULL, vat_amount NUMERIC(12, 2) NOT NULL, total_with_vat NUMERIC(12, 2) NOT NULL, UNIQUE INDEX UNIQ_72DBDC23429ECEE2 (invoice_id_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
